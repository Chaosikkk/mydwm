...
static const char *fonts[]          = { "JetBrainsMonoNL NF:size=13:style=Bold", "Font Awesome 6 Free Solid:size=13:style=Solid" };
...
static const Key keys[] = {
	...
	/* Custom */
        ...
        { MODKEY|ShiftMask,             XK_s,                       spawn,          SHCMD("sleep 0.2; scrot -s -e 'xclip -selection clipboard -t image/png -i $f' ~/Pictures/%m-%d-%Y-%H%M%S.png") },
	{ 0,				XK_Print,		    spawn,	    SHCMD("scrot -s ~/Pictures/%m-%d-%Y-%H%M%S.png") },
